...
**Intro script, story pass (Sep 14).** Lines 2, 3 and 4 rewritten for the light-and-sound story; lines 1 and 5 unchanged and still voiced. The old Intro2-4 recordings are parked in Assets/Audio/IntroOld (outside Resources) so those lines fall back to text timing until Nick records: 2 "They come as far as my fence and no further. It's the light. Light scares them off. Sound draws them in." 3 "Bullets won't kill them. A hit slows one down, and sends it running." 4 "Those stuck out in the woods move by day, and keep their fires at night." New clips go in Assets/Resources/Audio as Intro2.mp3, Intro3.mp3, Intro4.mp3.
